...
func Test_Day2(t *testing.T) {
	...
	assert.Equal(t, "", got)
	assert.ErrorContains(t, err, "invalid day (0) must be between 1 and 31")
}
...
func Test_Day3(t *testing.T) {
	...
	got, err := field.Format()
	assert.Equal(t, "", got)
	assert.ErrorContains(t, err, "invalid day (32) must be between 1 and 31")
}
...
func Test_List6(t *testing.T) {
	...
	got, err := field.Format()
	assert.Equal(t, "", got)
	assert.ErrorContains(t, err, "no day values were passed")
}
...
func Test_Range5(t *testing.T) {
	...
	got, err := field.Format()
	assert.Equal(t, "", got)
	assert.ErrorContains(t, err, "invalid day range, 'from' (4) must be less than 'to' (2)")
}
...
func Test_EveryX3(t *testing.T) {
	...
	got, err := field.Format()
	assert.Equal(t, "", got)
	assert.ErrorContains(t, err, "invalid day (0) must be between 1 and 15")
}
...
func Test_EveryX4(t *testing.T) {
	...
	got, err := field.Format()
	assert.Equal(t, "", got)
	assert.ErrorContains(t, err, "invalid day (16) must be between 1 and 15")
}
